function [satPositions,satVelocities,satClkCorr]=calc_sv_pos2(prn,ephmeris,transmitTime,transitTime)
...
T_GD=ephmeris.ephem((prn)).T_GD;
t_oc=ephmeris.ephem((prn)).t_oc;
a_f2=ephmeris.ephem((prn)).a_f2;
a_f1=ephmeris.ephem((prn)).a_f1;
a_f0=ephmeris.ephem((prn)).a_f0;
C_rc=ephmeris.ephem((prn)).C_rc;
C_rs=ephmeris.ephem((prn)).C_rs;
C_uc=ephmeris.ephem((prn)).C_uc;
C_us= ephmeris.ephem((prn)).C_us;
C_ic=ephmeris.ephem((prn)).C_ic;
C_is=ephmeris.ephem((prn)).C_is;
Delta_n=ephmeris.ephem((prn)).deltan;
M_0=ephmeris.ephem((prn)).M_0;
e=ephmeris.ephem((prn)).e;
sqrt_A=sqrt(ephmeris.ephem((prn)).A);; % Note this code assumes the data is sqrt A!!
t_oe=ephmeris.ephem((prn)).t_oe;
Omega_0=ephmeris.ephem((prn)).omega_0;
i_0=ephmeris.ephem((prn)).i_0;
omega=ephmeris.ephem((prn)).omega;
dot_Omega=ephmeris.ephem((prn)).omegaDot;
Idot=ephmeris.ephem((prn)).iDot;
% GPS constatns
